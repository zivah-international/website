...
const WHATSAPP_NUMBER = '593999002893';
const WHATSAPP_MESSAGE = encodeURIComponent(
  'Hola, estoy interesado en los productos de exportación de ZIVAH International.'
);
...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // Show after slight delay so it doesn't flash on initial load
