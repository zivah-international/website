    ...
    <div className='bg-background min-h-screen py-16'>
      <div className='container mx-auto max-w-4xl px-4'>
        ...
        <div className='mb-12 text-center'>
          <h1 className='text-foreground mb-4 text-4xl font-bold'>Política de Cookies</h1>
        ...
        <div className='bg-card space-y-8 rounded-xl p-8 shadow-lg'>
          ...
          <section>
            ...
            <h3 className='text-foreground mb-3 text-xl font-medium'>2.1 Cookies Esenciales</h3>
            ...
            <h3 className='text-foreground mb-3 text-xl font-medium'>2.2 Cookies de Rendimiento</h3>
            <p className='text-muted-foreground mb-4'>
            ...
            <h3 className='text-foreground mb-3 text-xl font-medium'>2.4 Cookies de Marketing</h3>
            <p className='text-muted-foreground mb-4'>
          ...
          {/* Third Party Cookies */}
          <section>
            <h2 className='text-foreground mb-4 text-2xl font-semibold'>3. Cookies de Terceros</h2>
          ...
          {/* Cookie Management */}
          <section>
            <h2 className='text-foreground mb-4 text-2xl font-semibold'>4. Gestión de Cookies</h2>

            <h3 className='text-foreground mb-3 text-xl font-medium'>4.1 Control de Cookies</h3>
            <p className='text-muted-foreground mb-4'>
          ...
          {/* Consent */}
          <section>
            <h2 className='text-foreground mb-4 text-2xl font-semibold'>5. Consentimiento</h2>
            <p className='text-muted-foreground mb-4 leading-relaxed'>
          ...
          {/* Data Retention */}
          <section>
            <h2 className='text-foreground mb-4 text-2xl font-semibold'>6. Retención de Datos</h2>
            <p className='text-muted-foreground leading-relaxed'>
          ...
          {/* Contact */}
          <section>
            <h2 className='text-foreground mb-4 text-2xl font-semibold'>8. Contacto</h2>
            <p className='text-muted-foreground mb-4 leading-relaxed'>
